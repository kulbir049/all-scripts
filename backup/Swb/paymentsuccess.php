          ...
          if(empty($api_error)){ 
              ...
              if($checkout_session->payment_status == 'paid'){ 
                  ...
                  if(!empty($prevRow)){ 
                    ...
                    ->setUsername('infofreelanceweb@gmail.com')
                    ->setPassword('lybnpbnpflyjfeqp');
                    ; 

                    $mailer = new Swift_Mailer($transport);

                    // Your HTML content
                    $content = '<h1 style="color:green;"> '.$statusMsg.'</h1>
                            <h4>Payment Information</h4>
                            <p><b>Reference Number:</b>'.$payment_id.'</p>
                            <p><b>Subscription ID:</b>'.$transactionID.'</p>
                            <p><b>Paid Amount:</b>'.$paidAmount.' '.$paidCurrency.'</p>
                            <p><b>Payment Status:</b> '.$payment_status.'</p>';

                    // Create a message
                    $message = (new Swift_Message('Welcome To Sweeba! subscription'))
                    ->setFrom(['info@sweeba.com' => 'Sweeba'])
                    ->setTo([$customer_email => $customer_name])
...
<div class="col-md-12" style="margin-left: auto; margin-right: auto;">
   <div class="content">
      ...
      <?php if(!empty($payment_id)){ ?>
        <h1 class="<?php echo $status; ?>" style="color:green;"><?php echo $statusMsg; ?></h1>  
        <h4>Payment Information</h4>
        <p><b>Reference Number:</b> <?php echo $payment_id; ?></p>
        <p><b>Subscription ID:</b> <?php echo $transactionID; ?></p>
