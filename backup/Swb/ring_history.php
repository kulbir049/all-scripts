...
<center>
<h1>Your Ring History</h1>
</center>
        <?php 
        $sql = "SELECT * FROM rings
        WHERE
            to_user_id = '".$_SESSION['user_id']."' ORDER BY id DESC";
        ...
        if($check == true)
        {
          ...
          while($row = $result->fetch_assoc()) 
          {
            ...
            if($row['type'] == 'Diamond')
            {
              $ring_icon = 'Diamond <img class="avatar" src="images/ring-diamond.png" style="width:50px;height:50px;display:inline-block;" title="Diamond">';
            }
            elseif($row['type'] == 'Gold')
            {
              $ring_icon = 'Gold <img class="avatar" src="images/ring-gold.jpeg" style="width:50px;height:50px;display:inline-block;"  title="Gold">';
            }
            else{
              $ring_icon = 'Silver <img class="avatar" src="images/ring-silver.png" style="width:50px;height:50px;display:inline-block;" title="Silver">';
            }
            ?>
                <div class="col-md-12 col-xs-12 text-center" style="background:#eef0f2;">
                <a href="https://www.sweeba.com/<?=$fromUserName ?>"> <img class="avatar" src="grab_image.php?img=<?php echo   $fromUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;"> <?php echo  $fromUserName;?></a> has sent a <?=$ring_icon;?> ring.
              </div> 
              <?php /*
          ...
          <?php $i++;}}else{?>
<div class="col-md-12 col-xs-12 text-center">
            <p>You currently have <b>(0)</b> rings.... </p><center>
<p><a href="https://www.sweeba.com/ring.php" class="btn btn-success" style="border:0px;background:#5fb5f2;font-size:23px;"><img src="https://sweeba.com/images/sweeba-match.png" width="25" height="25">  <b>Send Ring</b></a></p>
</center>
