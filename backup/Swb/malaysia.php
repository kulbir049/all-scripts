...
<div class="alert alert-info"><img class="img" src="/images/malaysiaflag.png" style="min-height:1px;min-width:1px;height:40px;width:40px;border-radius:0px;"></a>  Join <b>Malaysia</b> members earning </div>
