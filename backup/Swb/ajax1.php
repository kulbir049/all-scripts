...
$sql = "SELECT *  FROM sweebs WHERE status='active' AND status='check_in' AND user_id IN (" . implode(",", array_map("intval", $friends)) . ") ORDER BY id DESC LIMIT ".$postnumbers." OFFSET ".$offset."";
