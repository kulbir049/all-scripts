...
<div class="alert alert-info"><img class="img" src="/images/croatiaflag.png" style="min-height:1px;min-width:1px;height:40px;width:40px;border-radius:0px;border-radius:100%;"></a>  Join other <b>Croatians</b> earning on Sweeba</div>
