...
if($get_m_id != NULL){
$sql = "SELECT id, user_id, sweeb_id, date, comment FROM comments WHERE id='$get_m_id' AND user_id='$user_id' Limit 1";
...
$sql = "UPDATE comments SET comment='$comment' WHERE id='$get_m_id'";

if ($conn->query($sql) === TRUE) {
header("Location: /".$sweeb_id."/edit");
die();
} else {
...
<form method="post">
<textarea class="form-control form_in" name="message" style="border:1px solid #d3dce5;box-shadow:none;border-radius:0px;" rows="3"><?php echo $comment_edit; ?></textarea>
<br>
