...
<div class="alert alert-info"><img class="img" src="/images/bangladeshflag.png" style="min-height:1px;min-width:1px;height:40px;width:40px;border-radius:0px;border-radius:100%;"></a>  Join <b>Bangladesh</b> members earning </div>
...
<div class="alert alert-info"><img class="img" src="/images/bangladeshflag.png" style="min-height:1px;min-width:1px;height:40px;width:40px;border-radius:0px;border-radius:100%;"></a>  Join <b>Bangladesh</b> members earning on Sweeba</div>
