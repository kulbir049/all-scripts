...
<div class="clipboard" ><h4>Your Referral Link</h4><!-- The text field -->
<input type="text" value="https://www.sweeba.com/?ref=<?php echo $quick_fix; ?>" id="myInput">

          <!-- The button used to copy the text -->
<button onclick="myFunction()" class="btn-success">Copy</button></div></center></b></font>
</div>  
...
<center><div class="clipboard" ><!-- The text field -->
<input type="text" value="https://www.sweeba.com/images/468.gif" id="myInput3">
          <!-- The button used to copy the text -->
<button onclick="myFunction3()" class="btn-success">Copy</button></div></center></b></font>
</div>
...
<input type="text" value="https://www.sweeba.com/images/728.gif" id="myInput4">
          <!-- The button used to copy the text -->
<button onclick="myFunction4()" class="btn-success">Copy</button></div></center></b></font>
</div>
...
<input type="text" value="https://www.sweeba.com/images/336.gif" id="myInput5">
          <!-- The button used to copy the text -->
<button onclick="myFunction5()" class="btn-success">Copy</button></div></center></b></font>
</div>
...
<input type="text" value="https://www.sweeba.com/images/250.gif" id="myInput6">
          <!-- The button used to copy the text -->
<button onclick="myFunction6()" class="btn-success">Copy</button></div></center></b></font>
</div>
...
<input type="text" value="https://www.sweeba.com/images/120.gif" id="myInput7">
          <!-- The button used to copy the text -->
<button onclick="myFunction7()" class="btn-success">Copy</button></div></center></b></font>
</div>
