...
<div class="alert alert-info"><img class="img" src="/images/usaflag.png" style="min-height:1px;min-width:1px;height:40px;width:40px;border-radius:0px;"></a>  Join other <b>American's</b> earning on Sweeba </div>
...
<div class="alert alert-info"><img class="img" src="/images/usaflag.png" style="min-height:1px;min-width:1px;height:40px;width:40px;border-radius:0px;"></a>  Join <b>American</b> members earning on Sweeba </div>
