...
<h1>Your Matches</h1>
        ...
        FROM `match` m1
        JOIN `match` m2
            ON m1.from_user_id = m2.to_user_id
            AND m1.to_user_id = m2.from_user_id
        WHERE
            m1.from_user_id = '".$_SESSION['user_id']."'
            AND m1.status = 1
            AND m2.status = 1;";
        ...
        if($check == true)
        {
          ...
          while($row = $result->fetch_assoc()) 
          {
            ...
            $fromUserName    = $userFromDetail['username'];
            ...
            ?>
                <div class="col-md-12 col-xs-12 text-center" style="background:#eef0f2;">
                  <a href="https://www.sweeba.com/<?=$fromUserName ?>"><img class="avatar" src="grab_image.php?img=<?php echo   $fromUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;"> <?php echo  $fromUserName;?> </a> Likes  <a href="https://www.sweeba.com/<?=$toUserName ?>">  <?=$toUserName ?> <img class="avatar" src="grab_image.php?img=<?php echo  $toUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;"></a>
              </div> 
                <div class="col-md-12 col-xs-12 text-center" style="background:#eef0f2;">

                <a href="https://www.sweeba.com/<?=$toUserName ?>">  <img class="avatar" src="grab_image.php?img=<?php echo   $toUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;"> <?php echo  $toUserName;?> </a> Likes    <a href="https://www.sweeba.com/<?=$fromUserName ?>"> <?=$fromUserName ?> <img class="avatar" src="grab_image.php?img=<?php echo   $fromUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;"></a>
              </div> 
              <?php /*
              <div class="col-md-12 col-xs-12 text-center">
                  <img class="avatar" src="grab_image.php?img=<?php echo   $fromUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;"> <?php echo  $fromUserName;?> Likes <?=$toUserName ?> <img class="avatar" src="grab_image.php?img=<?php echo  $toUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;">
              </div> 
              <div class="col-md-12 col-xs-12 text-center" style="background:#eef0f2;">

                  <img class="avatar" src="grab_image.php?img=<?php echo   $toUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;"> <?php echo  $toUserName;?> Likes <?=$fromUserName ?> <img class="avatar" src="grab_image.php?img=<?php echo   $fromUserAvatar; ?>" style="height:50px;width:50px;display:inline-block;">
              </div> <?php */ ?>

          <?php $i++;}}else{?>
<div class="col-md-12 col-xs-12 text-center">
            <p>You currently have <b>(0)</b> matches.... </p><center>
<p><a href="https://www.sweeba.com/match.php" class="btn btn-success" style="border:0px;background:#5fb5f2;font-size:23px;"><img src="https://sweeba.com/images/sweeba-match.png" width="25" height="25">  <b>Find some matches now</b></a></p>
</center>
