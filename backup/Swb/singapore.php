...
<div class="alert alert-info"><img class="img" src="/images/singaporeflag.png" style="min-height:1px;min-width:1px;height:40px;width:40px;border-radius:0px;"></a>  Join <b>Singapore</b> members earning </div>
