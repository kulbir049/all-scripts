...
<div class="alert alert-info"><img class="img" src="/images/polandflag.png" style="min-height:1px;min-width:1px;height:40px;width:40px;border-radius:0px;border-radius:100%;"></a>  Join <b>Polish</b> members earning on Sweeba</div>
