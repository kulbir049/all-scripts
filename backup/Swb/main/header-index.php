...
<nav class="navbar navbar-default navbar-fixed-top" style="font-family: 'Open Sans', sans-serif; background:white;">
<div class="nav-marg">
...
<a href="<?php echo SITE_URL;?>dash.php"><img src="dist/img/sweeba.png"  class="logo hidden-xs"><img src="images/IVynm2a.png"   class="logo visible-xs"></a>
</div>
...
<li><a href="spin.php"> <img src="dist/img/wheel-icon.png" style="height:18px;width:18px;margin-top:-4px;"> Spin & Win</a></li>  
...
<?php } ?>
               <li><a href="raffle.php"> <img src="dist/img/ticketssmall.png" style="height:16px;width:16px;margin-top:-4px;"> Winners</a></li>     <li><a href="spin.php"> <img src="dist/img/wheel-icon.png" style="height:18px;width:18px;margin-top:-4px;"> Spin & Win</a></li>  
