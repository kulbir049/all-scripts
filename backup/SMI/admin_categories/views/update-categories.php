		...
		<!-- update document -->
            ...
            <div class="x_content contents">
                ...
                $field_attr = array(
                    ...
                    'class' => 'form-control',
                    'id' => 'id',
                    'value' => set_value('id', (!empty($parent_cat_id_data_row) && is_object($parent_cat_id_data_row) ? $parent_cat_id_data_row->id : ''))
                );
                ...
                <?php
                 ...
                 $field_attr = array(
                    'name' => 'root_parent_id',
                    'type' => 'hidden',
                    'value' => set_value('root_parent_id', $parent_cat_id_data_row->parent_id)
                );
                  echo form_input($field_attr);
                 ?>
				 <?php
                 $field_attr = array(
                    'name' => 'image_id',
                    'type' => 'hidden',
                    'value' => set_value('image_id', $parent_cat_img_id_data->id)
                );
                  echo form_input($field_attr);
                 ?>
				 <?php
                 $field_attr = array(
                    'name' => 'image_name',
                    'type' => 'hidden',
                    'value' => set_value('image_name', $parent_cat_img_id_data->image)
                );
                  echo form_input($field_attr);
                 ?>
                ...
                <div class="item form-group" id="sel_comp">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                        <select name="parent_id" class="select2_group form-control">
                            <option>Select Directory</option>
                            <?php cat_list('', '', $parent_cat_id_data_row->id); ?>
                ...
                <div class="item form-group" id="comp_name">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">
                        File Name <span class="required" style="color: red;">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">

                        <?php
						echo $parent_cat_img_id_data->image;
                        ?>
                    </div>
                </div>
                <div class="item form-group" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        $field_attr = array(
                            ...
                            'placeholder' => 'Enter Custom text',
                            'id' => 'custom_text',
                            'value' => set_value('custom_text', (!empty($parent_cat_id_data_row) && is_object($parent_cat_id_data_row) ? $parent_cat_id_data_row->custom_text : ''))
                        );
                ...
                <div class="item form-group" id="add_key" style="display:none;"> 
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        $field_attr = array(
                            ...
                            'placeholder' => 'Enter Keyword',
                            'id' => 'keyword',
                            'value' => set_value('keyword', (!empty($parent_cat_id_data_row) && is_object($parent_cat_id_data_row) ? $parent_cat_id_data_row->keyword : ''))
                        );
                ...
                <div class="item form-group" style="display:none;">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                        <?php
                        echo form_radio('priority', '1', set_radio('priority', '1', (!empty($parent_cat_id_data_row) && is_object($parent_cat_id_data_row) && $parent_cat_id_data_row->priority === "1") ? TRUE : FALSE))."Up";
                        ?>
                        <?php
                        echo form_radio('priority', '2', set_radio('priority', '2', (!empty($parent_cat_id_data_row) && is_object($parent_cat_id_data_row) && $parent_cat_id_data_row->priority === "2") ? TRUE : FALSE))."Down";
                        ?>
                        <?php
                        echo form_radio('priority', '0', set_radio('priority', '0', (!empty($parent_cat_id_data_row) && is_object($parent_cat_id_data_row) && $parent_cat_id_data_row->priority === "0" )? TRUE : FALSE))."None";
