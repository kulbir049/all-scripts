               ...
               <div class="accordion-header">
                  ...
                  <div class="naoTooltip-wrap">
                     ...
                     <div class="naoTooltip nt-right nt-small dd-handle">
                        ...
                        <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($category->id)."/"."mc"); ?>" title="Add Composer"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                     ...
                     <div class="accordion-header">
                        ...
                        <div class="naoTooltip-wrap" style="left: -234px;">
                           ...
                           <div class="naoTooltip nt-right nt-small dd-handle">
                              ...
                              <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($secondLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                           ...
                           <div class="accordion-header">
                              ...
                              <div class="naoTooltip-wrap" style="left: -216px;">
                                 ...
                                 <div class="naoTooltip nt-right nt-small dd-handle">
                                    ...
                                    <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($thirdLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                              ...
                              <div class="accordion-group" data-behavior="accordion" data-multiple="true">
                                 ...
                                 <div class="accordion-header">
                                    ...
                                    <div class="naoTooltip-wrap" style="left: -216px;">
                                       ...
                                       <div class="naoTooltip nt-right nt-small dd-handle">
                                          ...
                                          <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($fourthLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                                 ...
                                 <div class="accordion-body">
                                    <div class="accordion-group" data-behavior="accordion" data-multiple="true">
                                       ...
                                       <div class="accordion-header">
                                          <p>
                                             <!-- <?php echo (!empty($category) && is_object($category) ? $category->name : ''); ?> -->
                                          ...
                                          <div class="naoTooltip-wrap" style="left: -216px;">
                                             ...
                                             <div class="naoTooltip nt-right nt-small dd-handle">
                                                ...
                                                <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($fifthLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                                          ...
                                          <p class="custom_text" style="margin-left:25px;"><?php echo $fifthLevel->custom_text; ?>
                                          </p>
                                       </div>
                                       <!--------->
                                       <?php
                                             ...
                                             <div class="accordion-header">
                                                ...
                                                <div class="naoTooltip-wrap" style="left: -216px;">
                                                   ...
                                                   <div class="naoTooltip nt-right nt-small dd-handle">
                                                      ...
                                                      <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($sixthLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                                                ...
                                                <p class="custom_text" style="margin-left:25px;"><?php echo $sixthLevel->custom_text; ?>
                                                </p>
                                             </div>
                                             <!--------->
                                             <?php
                                                   ...
                                                   <div class="accordion-header">
                                                      ...
                                                      <div class="naoTooltip-wrap" style="left: -216px;">
                                                         ...
                                                         <div class="naoTooltip nt-right nt-small dd-handle">
                                                            ...
                                                            <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($seventhLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                                                      ...
                                                      <p class="custom_text" style="margin-left:25px;"><?php echo $seventhLevel->custom_text; ?>
                                                      </p>
                                                   </div>
                                                   <!--------->
                                                   <?php
                                                         ...
                                                         <div class="accordion-header">
                                                            ...
                                                            <div class="naoTooltip-wrap" style="left: -216px;">
                                                               ...
                                                               <div class="naoTooltip nt-right nt-small dd-handle">
                                                                  ...
                                                                  <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($eighthLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                                                            ...
                                                            <p class="custom_text" style="margin-left:25px;"><?php echo $eighthLevel->custom_text; ?>
                                                            </p>
                                                         </div>
                                                         <!--------->
                                                         <?php
                                                               ...
                                                               <div class="accordion-header">
                                                                  ...
                                                                  <div class="naoTooltip-wrap" style="left: -216px;">
                                                                     ...
                                                                     <div class="naoTooltip nt-right nt-small dd-handle">
                                                                        ...
                                                                        <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($ninthLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                                                                  ...
                                                                  <p class="custom_text" style="margin-left:25px;"><?php echo $ninthLevel->custom_text; ?>
                                                                  </p>
                                                               </div>
                                                               <!--------->
                                                               <?php
                                                                     ...
                                                                     <div class="accordion-header">
                                                                        ...
                                                                        <div class="naoTooltip-wrap" style="left: -216px;">
                                                                           ...
                                                                           <div class="naoTooltip nt-right nt-small dd-handle">
                                                                              ...
                                                                              <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($tenthLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                                                                        ...
                                                                        <p class="custom_text" style="margin-left:25px;"><?php echo $tenthLevel->custom_text; ?>
                                                                        </p>
                                                                     </div>
                                                                     <!--------->
                                                                     <?php
                                                                           ...
                                                                           <div class="accordion-header">
                                                                              ...
                                                                              <div class="naoTooltip-wrap" style="left: -216px;">
                                                                                 ...
                                                                                 <div class="naoTooltip nt-right nt-small dd-handle">
                                                                                    ...
                                                                                    <div><a href="<?php echo site_url('admin/category/add_composer/'.base64_encode($eleventhLevel->id)."/"."mc"); ?>" title="Add CustomText"><img src="<?php echo base_url() .'assets/admin/images/notepad.gif' ?>">&nbsp;&nbsp; Edit Composer</a></div>
                                                                              ...
                                                                              <p class="custom_text" style="margin-left:25px;"><?php echo $eleventhLevel->custom_text; ?>
                                                                              </p>
                                                                           </div>
                                                                           <?php } ?>
                                                                           <?php
