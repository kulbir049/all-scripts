        ...
        <div class="x_panel">
           ...
           <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" name="name"  id= "tags" class="form-control" placeholder="Search for Destination Folder" style=" width: 97%; margin-left: -7px; margin-bottom: 5px;">
                    </div>
                </div>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <div class="col-md-7 col-md-offset-3 pull-right"><input type="reset" class="btn btn-success my_button_new" name="submits" value="Back"><input type="submit" class="btn btn-success my_button_new" name="submits" value="Move Folder">
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
