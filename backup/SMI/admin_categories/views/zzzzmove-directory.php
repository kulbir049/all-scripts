    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
           ...
           <div class="row">
                    ...
                    <label class="option" style="width: 45%; padding: 0px; margin-bottom: 0px!important;">
                        <input name="rdbcomposer" value="14155" title="S.D" type="radio" class="select_radio1">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" name="name"  autocomplete='off' id= "tags" onchange="myFunction()" class="form-control" placeholder="Search for Destination Folder" style=" width: 97%; margin-left: -7px; margin-bottom: 5px;" list="browsers">
  ...
  $dynamic_url= $this->uri->segment(5); 
                ...
                <div class="form-group">
                    <div class="col-md-7 col-md-offset-3 pull-right">
                        ...
                        <input type="submit" class="btn btn-success my_button_new" name="submits" value="Move Folder" style="pointer-events: none;">
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
