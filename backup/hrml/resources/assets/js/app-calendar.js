$(function () {
    ...
    $(".fc-datepicker").datepicker({
        ...
        beforeShowDay: function (date) {
            ...
            for (var i = 0; i < highlightedDays.length; i++) {
                if (
                    $.inArray(y + "-" + (m + 1) + "-" + d, highlightedDays) !=
                    -1
                ) {
    ...
    var generateTime = function (element) {
        ...
        times = times.concat(
            times.slice(0).map(function (time) {
        ...
        eventRender: function (event, element) {
            if (event.description) {
                element
                    ...
                    .append(
                        '<span class="fc-desc">' + event.description + "</span>"
                    );
                element
                    .find(".fc-content")
                    .append(
    ...
    azCalendar.on("eventClick", function (calEvent, jsEvent, view) {
        ...
        modal
            ...
            .text(moment(calEvent.start).format("LLL"));
    ...
    $(".main-nav-calendar-event a").on("click", function (e) {
        ...
        if ($(this).hasClass("exclude")) {
            ...
            $(this).is(":nth-child(3)")
                ...
                : "";
            $(this).is(":nth-child(4)")
                ? azCalendar.addEventSource(azOtherEvents)
                : "";
        } else {
